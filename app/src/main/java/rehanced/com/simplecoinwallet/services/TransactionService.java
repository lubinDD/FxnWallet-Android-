package rehanced.com.simplecoinwallet.services;
...
public class TransactionService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            FCoinAPI.getInstance().getNonceForAddress(fromAddress, new Callback() {
                @Override
                ...
                public void onResponse(Call call, final Response response) throws IOException {
                    try {
                        ...
                        BigInteger nonce = new BigInteger(o.getString("result"), 16);
                        Integer retCode = new Integer(o.getString("code"));
    ...
    private void forwardTX(byte [] signed) throws IOException {
        FCoinAPI.getInstance().forwardTransaction("0x" + Hex.toHexString(signed), new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                error("Can't connect to network, retry it later");
            }
