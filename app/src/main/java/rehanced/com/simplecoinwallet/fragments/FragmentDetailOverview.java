...
import rehanced.com.simplecoinwallet.activities.SendActivity;
import rehanced.com.simplecoinwallet.data.CurrencyEntry;
import rehanced.com.simplecoinwallet.data.TokenDisplay;
...
import rehanced.com.simplecoinwallet.utils.Blockies;
...
import rehanced.com.simplecoinwallet.utils.TokenAdapter;
...
public class FragmentDetailOverview extends Fragment implements View.OnClickListener, View.OnCreateContextMenuListener, LastIconLoaded {
    ...
    public void update(boolean force) throws IOException {
        ...
        FCoinAPI.getInstance().getBalance(ethaddress, new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    token.add(0, new TokenDisplay("FxNow", "FNC", ethbal.multiply(new BigDecimal(1000d)), 3, 1, "", "", 0, 0));
        ...
        FCoinAPI.getInstance().getTokenBalances(ethaddress, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                ac.runOnUiThread(new Runnable() {
                    @Override
