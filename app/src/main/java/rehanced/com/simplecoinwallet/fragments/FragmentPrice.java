...
import rehanced.com.simplecoinwallet.views.DontShowNegativeFormatter;
import rehanced.com.simplecoinwallet.views.HourXFormatter;
import rehanced.com.simplecoinwallet.views.WeekXFormatter;
import rehanced.com.simplecoinwallet.views.YearXFormatter;
...
public class FragmentPrice extends Fragment {
    ...
    private void loadPriceData(final long time, int period) throws IOException {
        ...
        FCoinAPI.getInstance().getPriceChart((System.currentTimeMillis()/1000)-time, period, displayInUsd, new Callback() { // 1467321600,
            @Override
