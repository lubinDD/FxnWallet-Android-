...
import rehanced.com.simplecoinwallet.BuildConfig;
...
import rehanced.com.simplecoinwallet.services.TransactionService;
import rehanced.com.simplecoinwallet.utils.AddressNameConverter;
import rehanced.com.simplecoinwallet.utils.Blockies;
import rehanced.com.simplecoinwallet.utils.CollapseAnimator;
...
public class FragmentSend extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                try {
                    FCoinAPI.getInstance().getBalance(spinner.getSelectedItem().toString(), new Callback() {
                        @Override
                        ...
                        public void onResponse(Call call, final Response response) throws IOException {
                            ...
                            try {
                                curAvailable = new BigDecimal(ResponseParser.parseBalance(response.body().string()));
                                updateDisplays();
                            } catch (Exception e) {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (getCurTotalCost().compareTo(curAvailable) < 0 || BuildConfig.DEBUG || data.getText().length() > 0){
                        ...
                        ac.snackError(getString(R.string.err_send_not_enough_fnc));
                    }
                } catch(Exception e){
    ...
    private void getEstimatedGasPriceLimit(){
        try {
            FCoinAPI.getInstance().getGasLimitEstimate(toAddress.getText().toString(), new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {}
